...
namespace CSCore
{
    ...
    public class OwnWaveFormat : ICloneable, IEquatable<WaveFormat>
    {
        ...
        public OwnWaveFormat(int sampleRate, int bits, int channels)
        ...
        public OwnWaveFormat(int sampleRate, int bits, int channels, AudioEncoding encoding)
        ...
        public OwnWaveFormat(int sampleRate, int bits, int channels, AudioEncoding encoding, int extraSize)
        {
            if (sampleRate < 1)
