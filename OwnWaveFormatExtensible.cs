...
namespace CSCore
{
    ...
    public class OwnWaveFormatExtensible : OwnWaveFormat
    {
        ...
        public static Guid SubTypeFromWaveFormat(OwnWaveFormat waveFormat)
        {
            if (waveFormat == null)
                throw new ArgumentNullException("waveFormat");
            if (waveFormat is OwnWaveFormatExtensible)
                return ((OwnWaveFormatExtensible)waveFormat).SubFormat;
        ...
        internal OwnWaveFormatExtensible()
        {
        }
        ...
        public OwnWaveFormatExtensible(int sampleRate, int bits, int channels, Guid subFormat)
        ...
        /// </param>
        public OwnWaveFormatExtensible(int sampleRate, int bits, int channels, Guid subFormat, ChannelMask channelMask)
        ...
        public OwnWaveFormat ToWaveFormat()
        {
            return new OwnWaveFormat(SampleRate, BitsPerSample, Channels, AudioSubTypes.EncodingFromSubType(SubFormat));
        }
